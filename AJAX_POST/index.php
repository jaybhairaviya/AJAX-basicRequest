...
<html>
  ...
  http.open("POST","responseFile/response.php",true);

  // setting proper header to define the type of content we are sending
  http.setRequestHeader("Content-Type","application/x-www-form-urlencoded");

  // sending the ajax request to server with the data
  http.send("text="+text);
  });
  </script>
</html>
